...
mcmc_sum <- Model2_90_MVN$BUGSoutput$summary
...
# Optionally, a log scale on Y
# (guard against zero or negative probabilities)
ModelRCS2_90_plot_log <- ModelRCS2_90_plot +  scale_y_log10(breaks = c(0.001, 0.01, 0.03, 0.05, 0.07, 0.1))

ModelRCS2_90_plot_log

save(Model2_90_MVN, ModelRCS2_90_plot_log, ModelRCS2_90_plot_log, file="Saved_Data/Model2_90_rcs.RData")
