...
plotdata_studies <- lapply(studies, function(study_i) {
  ...
  # Fit the GLM (logistic) with 'composite_90' as outcome
  mod <- glm(
    formula = composite_90 ~ I(adjusted_timing),
    data    = df_sub,
    family  = binomial
  )
...
Model3_90_separate_plot <- ggplot() +
...
Model3_90_separate_plot


Model3_90_separate_plot_logy <- Model3_90_separate_plot +
  scale_y_log10() 
...
jags_data <- list(
  ...
  composite_90 = syn_data$composite_90, # Outcome variable
...
Model3_90_Linear <- jags.parallel(data = jags_data,inits=NULL,parameters.to.save = c("B", "tau","tau2", "u", "beta"),model.file = modelLinearTiming_3,
                               n.chains=2,n.iter = 20000,n.burnin = 2000,DIC=F,n.thin = 10)
print(Model3_90_Linear)

#### Tables of results
mcmc_sum <- Model3_90_Linear$BUGSoutput$summary
...
u_summaries <- Model3_90_Linear$BUGSoutput$summary[
  grep("^u\\[", rownames(Model3_90_Linear$BUGSoutput$summary)),
  "mean"
]
beta_summaries <- Model3_90_Linear$BUGSoutput$summary[
  grep("^beta\\[", rownames(Model3_90_Linear$BUGSoutput$summary)),
  "mean"
]
...
B_mean <- Model3_90_Linear$BUGSoutput$summary["B","mean"]
...
Model3_90_plot_log <- Model3_90_plot + scale_y_log10(breaks = c(0.001, 0.01, 0.03, 0.05, 0.07, 0.1))

Model3_90_plot_log


save(Model3_90_Linear, Model3_90_plot_log, Model3_90_plot, Model3_90_separate_plot, Model3_90_separate_plot_logy, file="Saved_Data/Model3_90_Linear.RData")
