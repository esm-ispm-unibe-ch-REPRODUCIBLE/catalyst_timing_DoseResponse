...
print(Model2_sich_MVN)


#### TABLES

# Extract the MCMC summary from the MVN model
mcmc_sum <- Model2_sich_MVN$BUGSoutput$summary
...
ModelRCS2_sich_plot_log <- ModelRCS2_sich_plot +  scale_y_log10(breaks = c(0.001, 0.01, 0.03, 0.05, 0.07, 0.1))

ModelRCS2_sich_plot_log


save(Model2_sich_MVN, ModelRCS2_sich_plot_log, ModelRCS2_sich_plot, file="Saved_Data/Model2_sich_rcs.RData")
